...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === "X") {
            //If activePlayer is equal to "X", the blackx.png is placed in HTML.
            select.style.backgroundImage = 'url("images/blackx.png")';
    //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayer is equal to 'O', the heart jpg is placed in HTML.
        ...
        if(activePlayer === 'O') {
            ...
            disableClick ();
            //This function waits 1 second before placing the images 
            //and enabling click.
            setTimeout(function () { computersTurn (); }, 1000);
        }
        //Returning true is needed for our computersTurn() functions at work.
        return true;
    }

    //This function resutls in a random square being selected. 
    function computersTurn () {
        //This boolean is needed for our while loop.
        let success = false;
        //This variable stores a random number 0-8
        let pickASquare;
        //This condition allows our while to keep
...
function checkWinConditions() {
    ...
    //X 6, 4, 2 condition. 
    else if (arrayIncludes ('6X', '4X', '2X')) {drawWinLine (100, 508, 501, 90); }
    //X 0, 4, 8 condition. 
